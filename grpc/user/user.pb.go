...
type User struct {
	...
	FollowingCount string `protobuf:"bytes,3,opt,name=following_count,json=followingCount,proto3" json:"following_count,omitempty"`
	// @gotags: json:"follower_count"
	FollowerCount string `protobuf:"bytes,4,opt,name=follower_count,json=followerCount,proto3" json:"follower_count,omitempty"`
}
...
func (x *User) GetFollowingCount() string {
	if x != nil {
...
var file_user_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x66, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x65,
